...
const GENERAL_FAQ = [
  {
    q: "מאיפה המוצר נשלח וכמה זמן זה לוקח?",
    a: "המוצרים מגיעים ישירות מהספק שלנו בסין, ולכן זמן האספקה ארוך יותר מקנייה בחנות פיזית - בדרך כלל בין שבוע לחודש, תלוי במוצר (הטווח המדויק מופיע למעלה בעמוד המוצר).",
  },
  {
